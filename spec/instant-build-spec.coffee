...
describe "instantBuild", ->
  [workspaceElement, activationPromise] = []

  beforeEach ->
    workspaceElement = atom.views.getView(atom.workspace)
    activationPromise = atom.packages.activatePackage('instant-build')

  describe "when the instant-build:toggle event is triggered", ->
    it "hides and shows the modal panel", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'instant-build:toggle'
        expect(instantBuildPanel.isVisible()).toBe false
    ...
    it "hides and shows the view", ->
      ...
      runs ->
        ...
        atom.commands.dispatch workspaceElement, 'instant-build:toggle'
        expect(instantBuildElement).not.toBeVisible()
